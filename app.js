...
console.log('Exercise 2 Results:', isAdult(21)); // should return 'Adult'
...
console.log('Exercise 4 Result:', generateEmail("tsujones", "space.com"));
...
const greetUser = (tsu, morning) => {
    return `Good ${morning}, ${tsu}!`;
};
console.log('Exercise 5 Result:', greetUser("Tsu", "morning")); // should return "Good morning, Tsu!"   
